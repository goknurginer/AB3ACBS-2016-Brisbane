...
Slow performance while analysing large collections of sets\\
\vfill
...
Fast performance while analysing large collections of sets for large experiments\\
\vfill
...
\begin{frame}
\frametitle{Shared features of {\ttfamily ROAST} and {\ttfamily FRY}}
